<?php include "header.php";?>
	...
	<div id="bannner" class="main_center_bannar" style="margin-top: 10%">
        ...
        <p style="text-align: center;font-size: 1.6em"><a href="./movie/" style="color: black">今日推荐电影《盗梦空间》：精美绝伦的梦境六重奏</a></p>
    </div>
	...
	<div id="bannner2" class="main_center_bannar" style="margin-top: 5%">
        ...
        <p style="text-align: center;font-size: 1.6em"><a href="./TV/" style="color: black">今日推荐电视剧《爱，死亡和机器人》：奈飞2019年度巨献</a></p>
    </div>
	...
	<div id="bannner3" class="main_center_bannar" style="margin-top: 5%;margin-bottom: 5%">
        ...
        <p style="text-align: center;font-size: 1.6em"><a href="./music/" style="color: black">今日推荐音乐专辑《lover》：第47届全美音乐奖“最受欢迎流行摇滚专辑”</a></p>
    </div>
