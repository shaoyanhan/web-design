...
<div id="top" style="background-image: url(img/header.jpg);width: 100%;height: 120px;background-repeat: no-repeat;background-size: cover;" >
    <div style="margin-left: 0.5%;margin-top: 0.5%;float: left;"><p style=";text-align: left;font-size: 1.5em;" ><a href="../index_login.php" style="color: black">邵燕涵的音影安利博客</a></p></div>
    ...
    <nav>
        <div class="wrap" style="margin-top: 0;margin-right: 0.5%;float: right;">
            <ul class="level" >
                ...
                <li>
                    <a href="../TV/index_login.php">电视剧</a>
                    <ul class="two">
                        <li><a href="../TV/index_login.php">本期推荐</a></li>
                        <li><a href="../former_login.php">往期回顾</a></li>
                    </ul>
                </li>
                <li>
